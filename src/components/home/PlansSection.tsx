...
function PlanCard({ plan }: { plan: Plan }) {
  return (
    <div
      className={`relative bg-white dark:bg-[#111111] rounded-2xl p-7 flex flex-col border transition-all duration-200 hover:border-green-500 dark:hover:border-green-600/50 shadow-sm dark:shadow-none ${
        plan.is_popular
